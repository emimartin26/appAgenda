...
ADMINS = (
    ('Emiliano Martin', 'emimartin26@hotmail.com'),
)
...
DATABASES = {
    'default': {
       'ENGINE': 'django.db.backends.postgresql_psycopg2', # Add 'postgresql_psycopg2', 'mysql', 'sqlite3' or 'oracle'.
        'NAME': 'd5n692tfefm8n9',                      # Or path to database file if using sqlite3.
        # The following settings are not used with sqlite3:
        'USER': 'zbcdfaebcypnch',
        'PASSWORD': '_G9s-Uh8B8xKSPdH90jJj3rOJw',
...
# DATABASES = {
   # 'default': {
    ...
    #    'NAME': 'dbAgenda',                      # Or path to database file if using sqlite3.
    #    # The following settings are not used with sqlite3:
    #    'USER': '',
   #     'PASSWORD': '',
...
SECRET_KEY = 'a(9o#*7k=so77p(sn9pja8*=s1#vehm!@!(6a@p!ly9$s=@nkp'
